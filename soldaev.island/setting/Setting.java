...
public class Setting {
    ...
    // Удав
    {
        HashMap<String, Integer> pyton = new HashMap<>();
        pyton.put("Wolf", 0);
        pyton.put("Pyton", 0);
        pyton.put("Fox", 15);
        pyton.put("Bear", 0);
        ...
        pyton.put("Buffalo", 0);
        pyton.put("Duck", 10);
        pyton.put("Caterpillar", 0);
        pyton.put("Plants", 0);
        foodTable.put("Pyton", pyton);
    }
    //Лиса
    {
    ...
    // Мышь
    {
        ...
        mouse.put("Plants", 100);
        foodTable.put("Muose", mouse);
    }
    // Коза
    {
